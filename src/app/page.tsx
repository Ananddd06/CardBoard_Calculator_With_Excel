      ...
      <section className="w-full max-w-6xl mt-20 flex flex-col items-center gap-10">
        ...
        <div className="w-full flex flex-col md:flex-row items-start gap-12">
          ...
          <div className="flex-1 flex justify-start">
            <img
              src="https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/24009477/original/d47c7f213fd85b2af29c1c24a76b057a21e5a61a/excel-database-data-entry-pdf-to-excel.jpeg"
